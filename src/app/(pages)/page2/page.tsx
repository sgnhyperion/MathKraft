    ...
    <div className="h-screen flex flex-col items-center justify-between">
      ...
      <div className="flex w-full h-[40%] gap-8 border-t-2 border-b-2 border-[#c0bdbd]">
            ...
            <div className="flex gap-2 h-[80%] w-full items-center justify-center">
              ...
              >
                <div className="border border-black h-full px-2 shadow-[-2px_2px_0px_black] pt-1 w-[90%] flex flex-col items-center justify-around bg-white">
                  <div className="text-6xl  text-purple-600">{mixedFraction.numerator}</div>
                  <div className="w-[90%] h-1 bg-black"></div>
                  <div className="text-6xl  text-purple-600">{mixedFraction.denominator}</div>
                </div>
        ...
        <div className="w-[50%] p-4 bg-[#ffffff] h-full">
            ...
            >
              <div className="text-green-600 text-3xl h-full w-1/2 p-2">WHOLES</div>
              {dropZone.whole && (
            ...
            <div
              ...
              onDragOver={handleDragOver}
            >
              <div className="text-[#a54dd7] text-3xl w-1/2  p-2 ">FRACTION</div>
              {dropZone.fraction && (
            ...
            <div className="text-[#f54f7b] mt-4 flex justify-center text-2xl">drop here</div>
        </div>
        ...
        <div className="h-[30%] bg-[#fff6f6] flex items-center justify-center w-full">
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="text-5xl tracking-wide flex items-center bg-[#ffffff] p-2">
              ...
              <MixedFraction color="text-[#ff497c]" size="text-5xl" whole={initialGameState.state1.mixedFraction.whole} num={initialGameState.state1.mixedFraction.numerator} denom={initialGameState.state1.mixedFraction.denominator} />
              ...
              <Fraction color="text-[#ff497c]" size="text-5xl" num={initialGameState.state1.mixedFraction.numerator} denom={initialGameState.state1.mixedFraction.denominator} />

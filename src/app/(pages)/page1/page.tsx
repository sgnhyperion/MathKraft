...
export default function Page1() {
  ...
  return (
    <div className="flex justify-center h-screen max-w-full bg-[#fff6f6]">
          ...
          <div className="flex items-center justify-center w-full h-full">
            ...
            <div className="w-[70%] h-full border-4 border-[#f54f7b] flex items-center justify-center">
              <div className="flex items-center justify-around space-x-2 w-[80%] h-inherit ">
                <MixedFraction whole={initialGameState.state1.mixedFraction.whole} num={initialGameState.state1.mixedFraction.numerator} denom={initialGameState.state1.mixedFraction.denominator} size={"text-6xl"} />
